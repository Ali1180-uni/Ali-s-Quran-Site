  ...
  return (
    ...
    >
      ...
      <motion.div 
        ...
        className="relative z-10 max-w-3xl text-center text-stone-100"
      >
        <motion.h1 
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.2, ease: [0.16, 1, 0.3, 1] }}
          className="text-4xl md:text-5xl font-semibold mb-6 tracking-wide"
        >
          Aim
        </motion.h1>
        ...
        <motion.p 
          ...
          className="leading-relaxed text-base md:text-lg text-stone-200"
        >
        ...
        <motion.div 
          ...
          className="max-w-7xl mx-auto px-6 flex flex-wrap justify-center gap-8 mt-16 mb-24 relative z-10"
        >
          <NavLink
            to="/Verse"
            className="
